...
"""Tutorial 18: ResNet-152 on Food-101 — heavy GPU benchmark.

Trains ResNet-152 (58M params) from scratch on Food-101 (101 classes,
75k training images, 224×224).  Requires ~14 GB VRAM at batch_size=64
— will OOM on 8 GB cards, designed for 16 GB GPUs (A4000, RTX 4080, etc.).
...
Prerequisites:
    ...
    5. Run: python tutorial/18_resnet152_food101.py
"""
...
async def main():
    ...
    h = await train_resnet152(epochs=10, batch_size=64, lr=0.01)
